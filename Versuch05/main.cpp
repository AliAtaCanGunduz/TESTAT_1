...
int main()
{
    ...
    do
    {
        std::cout << "\nMenue:" << std::endl
                  ...
                  << "(0): Beenden" <<std::endl<< "(4) : Datenbank rueckwaertsausgeben"<<std::endl<<"(5):Loesche das Datenelement anhand der Matrikelnummer."<<std::endl<<"(6):Datenelement vorne hinzufuegen"<<std::endl;
        std::cin >> abfrage;
        std::cin.ignore(10, '\n');
        ...
        switch (abfrage)
        {
            ...
            case '4':
                if (!studentenListe.empty()) {
                    std::cout << "Ausgabe in umgekehrter Reihenfolge" << std::endl;
            ...
            case '5':
                ...
                std::cout << "Bitte geben Sie die Matrikelnummer" << std::endl;
                std::cin >> matrikel;
                studentenListe.popMatrikelnnummer(matrikel);
                break;
